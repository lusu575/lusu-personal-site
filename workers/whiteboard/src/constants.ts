...
export const DEFAULT_CLIENT_UPDATE_INTERVAL_MS = 60;
export const LARGE_DOCUMENT_CLIENT_UPDATE_INTERVAL_MS = 200;
export const VERY_LARGE_DOCUMENT_CLIENT_UPDATE_INTERVAL_MS = 600;
