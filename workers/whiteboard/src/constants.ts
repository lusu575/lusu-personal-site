...
export const AGENT_ASSET_RECEIPT_PREFIX = "agent-asset-receipt:";
...
export const MAX_AGENT_ASSET_RECEIPTS = 128;
...
export const AGENT_ASSETS_AUTHORIZED_HEADER = "x-whiteboard-agent-assets-authorized";
