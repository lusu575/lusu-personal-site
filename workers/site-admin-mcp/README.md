...
On 2026-08-11, internal candidate `0.4.0` was temporarily deployed as exact version `9b0bd726-2c15-414c-bdff-fc5179b4e003`. DCR, PKCE, owner OAuth, and an exact 23-tool discovery passed, but a link-only YouTube `video_publish` failed closed with `VIDEO_METADATA_TITLE_UNAVAILABLE` before any video, category, receipt, or audit write. The temporary grant was revoked and production was rolled back to `849d8328-87db-4ac8-819a-ce725fc06349` at 100% traffic. The repository candidate now adds a bounded official YouTube watch-page fallback after oEmbed failure, but that revision is neither deployed nor production-accepted. Do not promote registry availability or repeat OAuth acceptance until the owner explicitly authorizes a new run.
