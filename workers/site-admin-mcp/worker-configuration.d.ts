/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8079d8d91689ca4c8fcb9d563d98c89b)
// Runtime types generated with workerd@1.20260730.1 2026-08-07 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	DB: D1Database;
	ANALYTICS_IP_HASH_SALT: string;
	GAME_RELAY: DurableObjectNamespace<import("./src/index").GameRelaySession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameRelaySession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANALYTICS_IP_HASH_SALT">> {}
}
