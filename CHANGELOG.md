...
- 新增临时互传客户端 UI 合约测试与移动文章构建守卫；公开 `site-updates` 记录使用 `seed-update-2026-07-17-mobile-transfer-send-fix`，已同步 `js/main.js` fallback、Functions seed 与 schema seed，相关主站资源 query 更新为 `20260717-mobile-transfer-send-r1`。
