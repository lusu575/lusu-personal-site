...
const adminUpdates = [
  ...
  },
  {
    date: "2026-06-22",
    title: "地区来源明细增加比例概览",
    body: "第 22 轮 loop 在访问来源页的地区明细表上方新增“地区来源概览”比例条，筛选后同步展示匹配来源的前 6 条浏览/访客表现；IP 前缀表格仍保留用于复制和排查。后台资源版本更新为 20260622-admin-insight-r20。"
  },
  {
    date: "2026-06-22",
    title: "最近点击新增本地筛选",
  ...
  },
  {
    date: "2026-06-22",
    title: "地区来源明细新增本地筛选",
    body: "第 20 轮 loop 在访问来源页的“省份 / 地区 / IP 来源”明细表上方新增本地筛选框，可按国家、地区、城市和 IP 前缀快速定位来源；计数同步显示“显示 X / 共 Y”。后台资源版本更新为 20260622-admin-insight-r18。"
  },
  {
    date: "2026-06-22",
    title: "后台标识文案中文化",
  ...
  },
  {
    date: "2026-06-22",
    title: "统计与治理文案去英文缩写",
    body: "第 12 轮 loop 将实时大屏里的 PV/UV 解释改为“浏览量/独立访客”，聊天室消息详情和禁言提示里的 IP hash 改为“隐藏 IP 指纹”，减少后台运行时的英文缩写直出。后台资源版本更新为 20260622-admin-insight-r10。"
  },
  {
    date: "2026-06-22",
    title: "后台运行文案去除 slug 直出",
    body: "第 11 轮 loop 将文章保存校验、视频分类列表摘要和分类完整提示里的 slug 直出改为“路径标识”，让后台运行界面尽量使用中文说明；字段名和接口参数仍保持不变。后台资源版本更新为 20260622-admin-insight-r9。"
  },
  {
    date: "2026-06-22",
    title: "文章列表改用标题识别",
    body: "第 10 轮 loop 将知识库文章列表的主标题从路径标识改为文章标题，路径标识退到次级信息，减少站长在文章管理里靠 slug 识别内容的成本。后台文章列表接口只补充读取已有标题字段，不改变权限、保存逻辑或数据库结构；后台资源版本更新为 20260622-admin-insight-r8。"
  },
  {
    date: "2026-06-22",
    title: "顶部面板说明继续中文化",
    body: "第 9 轮 loop 将后台切换面板后的顶部说明继续中文化：文章说明不再显示 zh/en/ja，视频说明减少平台名堆叠，访问来源说明补充“掩码 IP 前缀”，社交链接说明改为“社交入口”。后台资源版本更新为 20260622-admin-insight-r7，功能逻辑和接口不变。"
  },
  {
    date: "2026-06-22",
    title: "未知页面路径显示收口",
  ...
  },
  {
    ...
    body: "第 4 轮 loop 继续减少后台统计页的长表格：访问来源页的国家来源改为中文地区比例条，点击埋点页的点击热点改为按目标聚合的比例条；地区/IP 明细表保留为工具表，方便继续复制掩码 IP 前缀。后台资源版本更新为 20260622-admin-insight-r2，权限、接口和数据写入不变。"
  },
  {
    date: "2026-06-22",
