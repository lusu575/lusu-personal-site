// Historical content baseline. New releases belong in article-release-seed.mjs.
...
export function articleSeedStatements(env, { articleTranslationsStatements }) {
  ...
  return [
    ...
    ...articleTranslationsStatements(env, "seed-update-2026-08-20-chat-whiteboard-ui-fixes", {
      zh: {
        title: "聊天室与在线画板界面修复",
        summary: "聊天室移除消息区和输入区的异常留白，把发送按钮收进输入框并改为清晰的方角 XP 操作；聊天室密码房说明改为悬浮显示，在线画板保留三语说明和 Image2 像素大厅。",
      ...
      en: {
        ...
        summary: "Chat removes oversized gaps and places a clearer square-corner XP send key inside the input. Its password-room guide now appears on hover, while Whiteboard keeps trilingual help and its Image2 pixel lobby.",
      ...
      ja: {
        ...
        summary: "チャットの余分な空白をなくし、入力欄内の送信操作を見やすい角型XPボタンにしました。チャットのパスワード説明はホバー表示となり、画板は三言語説明とImage2のピクセル入口を維持します。",
