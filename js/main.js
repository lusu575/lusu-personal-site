...
import { homeContent } from "./data/home-content.mjs?v=20260806-japanese-agent-progress-r1";
...
const routeModuleRegistry = createRouteModuleRegistry({
  loaders: {
    ...
    resources: () => Promise.all([
      import("./routes/resources.mjs?v=20260806-japanese-agent-progress-r1"),
      import("./data/resources-content.mjs?v=20260806-japanese-agent-progress-r1")
