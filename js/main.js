  ...
  updates: [
    {
      ...
      date: "2026.07.14",
      title: {
        zh: "日语潜台词训练工具更新至 1.0.4",
        en: "Behind the Japanese 1.0.4 Update",
        ja: "日本語の裏側 1.0.4 アップデート"
      },
      summary: {
        zh: "“日语的言外之意”1.0.4 使用 AivisSpeech 按审校假名重新生成全库 AI 语音，并以 gpt-image-2 重制 250 张精制黑白四格题目配图和简洁彩色站外背景，同时重整桌面与手机交互。版本边界为 appVersion 1.0.4 / contentVersion 1.0.3。",
        en: "Behind the Japanese 1.0.4 regenerates the full AI voice library with AivisSpeech from reviewed kana, replaces all 250 stage illustrations with polished monochrome four-panel manga, adds quiet full-color outer backdrops, and refines desktop and mobile interaction. Its version boundary is appVersion 1.0.4 / contentVersion 1.0.3.",
        ja: "「日本語の裏側」1.0.4 では、確認済みのかな読みから AivisSpeech で全 AI 音声を再生成し、250 ステージの精細なモノクロ四コマと外側の控えめなカラー背景を gpt-image-2 で作り直して、PC・モバイルの操作も再整理しました。バージョン境界は appVersion 1.0.4 / contentVersion 1.0.3 です。"
      },
      content_markdown: {
