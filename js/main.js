...
const content = {
  updates: [
    {
      article_id: "seed-update-2026-07-14-japanese-subtext-v1-0-4",
      ...
      published_at: "2026-07-14T02:50:00.000Z",
      fallbackOnly: true,
      icon: "system",
      date: "2026.07.14",
      title: {
        zh: "日语潜台词训练工具 1.0.4 音频优先候选进度",
        en: "Behind the Japanese 1.0.4 Audio-First Candidate Progress",
        ja: "日本語の裏側 1.0.4 音声優先候補の進捗"
      },
      summary: {
        zh: "“日语的言外之意”1.0.4 尚未上线：contentVersion 1.0.3 的 10,088 段音频和 250 份 timeline 已完成 rebound 与验证，MP3 字节未改；运行时仍使用 250 张 assetContentVersion 1.0.2 legacy 配图。Image2 checkpoint 为 14/252，仍缺 238 张，待图片与背景补齐、release-check 和浏览器 QA 后才发布。",
        en: "Behind the Japanese 1.0.4 is not live: 10,088 audio files and 250 timelines for contentVersion 1.0.3 were rebound and verified without changing MP3 bytes; runtime still uses 250 legacy illustrations from assetContentVersion 1.0.2. The Image2 checkpoint is 14/252, with 238 missing. Release waits for the remaining images and backdrops, release-check, and browser QA.",
        ja: "「日本語の裏側」1.0.4 は未公開です。contentVersion 1.0.3 の音声 10,088 件と timeline 250 件は rebound と検証を完了し、MP3 のバイト列は変更していません。実行時は assetContentVersion 1.0.2 の legacy 画像 250 枚を継続使用しています。Image2 checkpoint は 14/252、残り 238 枚で、画像と背景、release-check、ブラウザー QA の完了後にのみ公開します。"
      },
      content_markdown: {
