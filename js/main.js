import {
  ...
  normalizeLanguage,
  translationFor
} from "./core/i18n.mjs?v=20260729-knowledge-markdown-links-r1";
import { homeContent } from "./data/home-content.mjs?v=20260729-knowledge-markdown-links-r1";
...
const routeModuleRegistry = createRouteModuleRegistry({
  loaders: {
    knowledge: () => loadStyledRoute("knowledge", () => import("./routes/knowledge.mjs?v=20260729-knowledge-markdown-links-r1"),
