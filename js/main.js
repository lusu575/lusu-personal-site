...
import { homeContent } from "./data/home-content.mjs?v=20260806-agent-auth-form-origin-r1";
...
const routeModuleRegistry = createRouteModuleRegistry({
  loaders: {
    ...
    resources: () => Promise.all([
      import("./routes/resources.mjs?v=20260806-agent-auth-form-origin-r1"),
      import("./data/resources-content.mjs?v=20260806-agent-auth-form-origin-r1")
