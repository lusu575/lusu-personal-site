...
export const translations = {
  zh: {
    ...
    accountErrorEmailExists: "这个邮箱已经注册，请切换到登录。",
  ...
  en: {
    ...
    accountErrorEmailExists: "This email is already registered. Switch to Log in.",
  ...
  ja: {
    ...
    accountErrorEmailExists: "このメールは登録済みです。ログインに切り替えてください。",
