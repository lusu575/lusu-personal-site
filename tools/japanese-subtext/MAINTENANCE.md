...
下一待发布候选：应用 `1.0.4`、内容 `1.0.3`（阶段状态：2026-07-14）；尚未完成公开发布。

2026-07-16 起，该候选保存在独立 WIP 分支中；恢复点、已保存证据、缺口与下一轮完整重生 Image2 的操作边界见 [`WIP_STATUS.md`](./WIP_STATUS.md)。旧 checkpoint／review 只用于溯源，不得自动当作正式发布资产。
