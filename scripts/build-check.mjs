...
const requiredFiles = [
  ...
  "lib/capabilities/daily-ai-news-publish-adapter.mjs",
  ...
  "workers/daily-ai-news-mcp/README.md",
  "workers/daily-ai-news-mcp/package-lock.json",
  "workers/daily-ai-news-mcp/package.json",
  "workers/daily-ai-news-mcp/scripts/check-generated-types.mjs",
  "workers/daily-ai-news-mcp/src/access-auth.ts",
  "workers/daily-ai-news-mcp/src/index.ts",
  "workers/daily-ai-news-mcp/wrangler.jsonc",
  "package-lock.json",
  "package.json",
