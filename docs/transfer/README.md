...
- 图标与返回状态：生产图集必须为 168×168 RGBA，16 格四角透明且没有洋红方块；执行 `npm.cmd run audit:resources-layout`，以 zh/en/ja 和 359×500、375×667、390×844、760×900、844×390、1280×720 确认 Resources → 登录任务 → 返回 Resources 恢复原分类栏/列表状态与几何，当前受控矩阵为 58 / 58。
