...
function defineCapability(capability) {
  ...
  if (typeof capability.scope !== "string" || !/^[a-z0-9][a-z0-9:-]{2,119}$/.test(capability.scope)) {
    throw new TypeError(`Capability ${capability.id} has an invalid primary scope.`);
  }
  const requiredScopes = capability.requiredScopes ?? [capability.scope];
  const anyOfScopes = capability.anyOfScopes ?? [];
  if (!Array.isArray(requiredScopes) || requiredScopes.length === 0 || !requiredScopes.includes(capability.scope)) {
    throw new TypeError(`Capability ${capability.id} requiredScopes must include its primary scope.`);
  }
  if (!Array.isArray(anyOfScopes)) {
    throw new TypeError(`Capability ${capability.id} anyOfScopes must be an array.`);
  }
  for (const scope of [...requiredScopes, ...anyOfScopes]) {
    if (typeof scope !== "string" || !/^[a-z0-9][a-z0-9:-]{2,119}$/.test(scope)) {
      throw new TypeError(`Capability ${capability.id} has an invalid scope requirement.`);
    }
  }
  return Object.freeze({
    ...
    requiredScopes: Object.freeze([...new Set(requiredScopes)]),
    anyOfScopes: Object.freeze([...new Set(anyOfScopes)])
  });
}
...
const capabilities = [
  ...
  {
    id: "content.articles.manage-list",
  ...
  {
    id: "content.articles.manage-get",
    domain: "knowledge-management",
    scope: "content:write",
    transport: ["site-api", "remote-mcp", "local-mcp", "cli"],
    availableTransports: ["site-api", "remote-mcp", "local-mcp", "cli"],
  ...
  {
    id: "content.videos.manage-list",
    domain: "video-management",
    scope: "content:write",
    transport: ["site-api", "remote-mcp", "local-mcp", "cli"],
    availableTransports: ["site-api"],
    readOnly: true,
    destructive: false,
    idempotent: true,
    risk: "medium",
  ...
  {
    id: "content.videos.upload-begin",
    domain: "video-management",
    scope: "content:write",
    transport: ["site-api", "remote-mcp", "local-mcp", "cli"],
    availableTransports: [],
  ...
  {
    id: "content.videos.upload-status",
    domain: "video-management",
    scope: "content:write",
    transport: ["site-api", "remote-mcp", "local-mcp", "cli"],
    availableTransports: [],
  ...
  {
    id: "content.videos.upload-commit",
    domain: "video-management",
    scope: "content:write",
    transport: ["site-api", "remote-mcp", "local-mcp", "cli"],
    availableTransports: [],
  ...
  {
    id: "content.videos.upload-abort",
    domain: "video-management",
    scope: "content:write",
    transport: ["site-api", "remote-mcp", "local-mcp", "cli"],
    availableTransports: [],
  ...
  },
  {
    ...
    requiredScopes: Object.freeze(["whiteboard:write", "whiteboard:assets"]),
    transport: ["site-api", "local-mcp", "cli"],
    availableTransports: ["site-api", "local-mcp", "cli"],
    readOnly: false,
    destructive: false,
  ...
  {
    id: "whiteboard.scene.images.apply",
    domain: "whiteboard",
    scope: "whiteboard:assets",
    requiredScopes: Object.freeze(["whiteboard:write", "whiteboard:assets"]),
    transport: ["site-api", "local-mcp", "cli"],
  ...
  {
    id: "whiteboard.assets.download",
    domain: "whiteboard",
    scope: "whiteboard:assets",
    requiredScopes: Object.freeze(["whiteboard:assets"]),
    anyOfScopes: Object.freeze(["whiteboard:read", "whiteboard:write"]),
    transport: ["site-api", "local-mcp", "cli"],
    availableTransports: ["site-api", "local-mcp", "cli"],
    readOnly: true,
    destructive: false,
  ...
  {
    id: "games.browser.pair",
    domain: "games",
    scope: "games:play",
    transport: ["remote-mcp", "browser-adapter"],
    availableTransports: [],
    readOnly: false,
    destructive: false,
    idempotent: true,
