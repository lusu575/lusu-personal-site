...
test("remote D1 verification groups stay within the production compound SELECT limit", () => {
  ...
  assert.match(verificationSql, /article_seed_version' and value = '20260810-wallpaper-switch-slim-dawn-r1'/);
  assert.match(verificationSql, /slug = '2026-08-10-wallpaper-switch-slim-dawn'/);
  assert.match(verificationSql, /published_at = '2026-08-10T02:30:00.000Z'/);
