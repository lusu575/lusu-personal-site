...
- Keep LuSu's Neo-XP / Pixel Glass shell, then evoke a friendly 2000s language-learning CD-ROM inside the tool: cobalt title bars, warm cream reading paper, mint progress, sun-yellow focus, chunky one-pixel edges, and small generated full-color crayon or abstract chibi four-panel illustrations. Black-and-white line art is not part of this tool's visual language.
